...
絶対条件：
- お客様の選択項目（vibe /purpose /  avoid_colors / nail_duration / age）を優先的に踏襲
- 奇抜すぎない：新しさは80%程度。新しい自分を発見できるデザイン。
- 日常に馴染みつつ、洗練された雰囲気。ただし、マットに寄りすぎず艶も適度に
- ベージュ単色に寄りすぎない。程よく鮮やかに
- ストーンやラメ、アートなどは回答に応じて適切に。華やかさをワンポイント
